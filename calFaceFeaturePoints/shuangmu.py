...
class StereoCalibration(object):
    def __init__(self):
        self.imagesL = self.read_images('D:/MyFiles/imageCap/newLeft')
        self.imagesR = self.read_images('D:/MyFiles/imageCap/newRight')
    ...
    def stereo_calibrate(self, objpoints, imgpoints_l, imgpoints_r, M1, d1, M2, d2, dims):
        ...
        ret, M1, d1, M2, d2, R, T, E, F = cv2.stereoCalibrate(objpoints, imgpoints_l, imgpoints_r, M1, d1, M2, d2, dims,
